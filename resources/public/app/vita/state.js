...
return cljs.core.first.call(null,(function (){var iter__13381__auto__ = (function iter__14471(s__14472){
return (new cljs.core.LazySeq(null,(function (){
var s__14472__$1 = s__14472;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__14472__$1);
if(temp__4126__auto__){
var s__14472__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__14472__$2)){
var c__13379__auto__ = cljs.core.chunk_first.call(null,s__14472__$2);
var size__13380__auto__ = cljs.core.count.call(null,c__13379__auto__);
var b__14474 = cljs.core.chunk_buffer.call(null,size__13380__auto__);
if((function (){var i__14473 = (0);
while(true){
if((i__14473 < size__13380__auto__)){
var vec__14477 = cljs.core._nth.call(null,c__13379__auto__,i__14473);
...
cljs.core.chunk_append.call(null,b__14474,k);

var G__14479 = (i__14473 + (1));
i__14473 = G__14479;
continue;
} else {
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__14474),iter__14471.call(null,cljs.core.chunk_rest.call(null,s__14472__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__14474),null);
}
} else {
var vec__14478 = cljs.core.first.call(null,s__14472__$2);
var k = cljs.core.nth.call(null,vec__14478,(0),null);
var v = cljs.core.nth.call(null,vec__14478,(1),null);
if(cljs.core.truth_(id.equals(v))){
return cljs.core.cons.call(null,k,iter__14471.call(null,cljs.core.rest.call(null,s__14472__$2)));
} else {
var G__14481 = cljs.core.rest.call(null,s__14472__$2);
s__14472__$1 = G__14481;
continue;
}
}
} else {
...
return cljs.core.swap_BANG_.call(null,vita.state.state,(function (p1__14482_SHARP_){
return cljs.core.assoc.call(null,p1__14482_SHARP_,new cljs.core.Keyword(null,"ws-items","ws-items",-4575020),fn.call(null,new cljs.core.Keyword(null,"ws-items","ws-items",-4575020).cljs$core$IFn$_invoke$arity$1(p1__14482_SHARP_)));
}));
});
vita.state.ws_add_BANG_ = (function ws_add_BANG_(item){

return vita.state.ws_items_update.call(null,(function (p1__14483_SHARP_){
return cljs.core.conj.call(null,p1__14483_SHARP_,item);
}));
});
vita.state.ws_update_BANG_ = (function ws_update_BANG_(key,updater){

return vita.state.ws_items_update.call(null,(function (p1__14484_SHARP_){
...
return cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__14485_SHARP_){
return cljs.core._EQ_.call(null,key,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(p1__14485_SHARP_));
...
return cljs.core.some.call(null,cljs.core.true_QMARK_,cljs.core.map.call(null,(function (p1__14486_SHARP_){
return cljs.core._EQ_.call(null,key,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(p1__14486_SHARP_));
}),ws_items));
});
...
var seq__14491 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,vita.state.events),action));
var chunk__14492 = null;
var count__14493 = (0);
var i__14494 = (0);
while(true){
if((i__14494 < count__14493)){
var handler = cljs.core._nth.call(null,chunk__14492,i__14494);
cljs.core.apply.call(null,handler,params);

var G__14495 = seq__14491;
var G__14496 = chunk__14492;
var G__14497 = count__14493;
var G__14498 = (i__14494 + (1));
seq__14491 = G__14495;
chunk__14492 = G__14496;
count__14493 = G__14497;
i__14494 = G__14498;
continue;
} else {
var temp__4126__auto__ = cljs.core.seq.call(null,seq__14491);
if(temp__4126__auto__){
var seq__14491__$1 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14491__$1)){
var c__13412__auto__ = cljs.core.chunk_first.call(null,seq__14491__$1);
var G__14499 = cljs.core.chunk_rest.call(null,seq__14491__$1);
var G__14500 = c__13412__auto__;
var G__14501 = cljs.core.count.call(null,c__13412__auto__);
var G__14502 = (0);
seq__14491 = G__14499;
chunk__14492 = G__14500;
count__14493 = G__14501;
i__14494 = G__14502;
continue;
} else {
var handler = cljs.core.first.call(null,seq__14491__$1);
cljs.core.apply.call(null,handler,params);

var G__14503 = cljs.core.next.call(null,seq__14491__$1);
var G__14504 = null;
var G__14505 = (0);
var G__14506 = (0);
seq__14491 = G__14503;
chunk__14492 = G__14504;
count__14493 = G__14505;
i__14494 = G__14506;
continue;
}
} else {
...
while (G__14507__i < G__14507__a.length) {G__14507__a[G__14507__i] = arguments[G__14507__i + 1]; ++G__14507__i;}
  params = new cljs.core.IndexedSeq(G__14507__a,0);
} 
return trigger__delegate.call(this,action,params);};
trigger.cljs$lang$maxFixedArity = 1;
trigger.cljs$lang$applyTo = (function (arglist__14508){
var action = cljs.core.first(arglist__14508);
var params = cljs.core.rest(arglist__14508);
...
return (console["error"]).apply(console,cljs.core.into_array.call(null,cljs.core.map.call(null,vita.log.prepare,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["websocket: error: %s",p1__14509_SHARP_], null))));
});})(s,send))
);
...
var map__14512 = cljs.core.js__GT_clj.call(null,data,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true);
...
var params = cljs.core.get.call(null,map__14512__$1,new cljs.core.Keyword(null,"params","params",710516235));
var action = cljs.core.get.call(null,map__14512__$1,new cljs.core.Keyword(null,"action","action",-811238024));
...
return send.call(s,JSON.stringify(cljs.core.clj__GT_js.call(null,p1__14510_SHARP_)));
});})(s,send))
);
...
;
vita.state.req_atom = (function req_atom(p__14513){
var map__14515 = p__14513;
var map__14515__$1 = ((cljs.core.seq_QMARK_.call(null,map__14515))?cljs.core.apply.call(null,cljs.core.hash_map,map__14515):map__14515);
...
return cljs.core.swap_BANG_.call(null,vita.state.state,cljs.core.assoc,new cljs.core.Keyword(null,"atoms-list","atoms-list",687904585),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__14516_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[vita.state.next_key.call(null),vita.atom.read_id.call(null,p1__14516_SHARP_)],null));
}),items)));
}));
...
return vita.state.ws_update_BANG_.call(null,key,(function (p1__14517_SHARP_){
return cljs.core.assoc.call(null,p1__14517_SHARP_,new cljs.core.Keyword(null,"state","state",-1988618099),new cljs.core.Keyword(null,"edit","edit",-1641834166));
}));
}));
vita.state.on.call(null,new cljs.core.Keyword(null,"ws-preview","ws-preview",-2123346689),(function (key){
return vita.state.ws_update_BANG_.call(null,key,(function (p1__14518_SHARP_){
return cljs.core.assoc.call(null,p1__14518_SHARP_,new cljs.core.Keyword(null,"state","state",-1988618099),new cljs.core.Keyword(null,"preview","preview",451279890));
}));
}));
vita.state.on.call(null,new cljs.core.Keyword(null,"ws-save","ws-save",2026921381),(function (key){
return vita.state.ws_update_BANG_.call(null,key,(function (p1__14519_SHARP_){
return cljs.core.assoc.call(null,p1__14519_SHARP_,new cljs.core.Keyword(null,"state","state",-1988618099),new cljs.core.Keyword(null,"view","view",1247994814));
}));
}));

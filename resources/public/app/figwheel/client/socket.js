...
figwheel.client.socket.open = (function open(p__25976){
...
var opts = map__25978__$1;
var build_id = cljs.core.get.call(null,map__25978__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
var retried_count = cljs.core.get.call(null,map__25978__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var retry_count = cljs.core.get.call(null,map__25978__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
...
socket.onmessage = ((function (socket,map__25978,map__25978__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (msg_str){
var temp__4126__auto__ = cljs.reader.read_string.call(null,msg_str.data);
if(cljs.core.truth_(temp__4126__auto__)){
var msg = temp__4126__auto__;
var and__12613__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__12613__auto__){
var and__12613__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__12613__auto____$1)){
var and__12613__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
if(and__12613__auto____$2){
var and__12613__auto____$3 = figwheel.client.socket.proper_build_id.call(null,build_id,msg);
if(and__12613__auto____$3){
...
});})(socket,map__25978,map__25978__$1,opts,build_id,websocket_url,retried_count,retry_count))
;

socket.onopen = ((function (socket,map__25978,map__25978__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
socket.onclose = ((function (socket,map__25978,map__25978__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
var retried_count__$1 = (function (){var or__12625__auto__ = retried_count;
...
return window.setTimeout(((function (retried_count__$1,socket,map__25978,map__25978__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (){
...
});})(retried_count__$1,socket,map__25978,map__25978__$1,opts,build_id,websocket_url,retried_count,retry_count))
,(function (){var x__12949__auto__ = (10000);
var y__12950__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (socket,map__25978,map__25978__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
